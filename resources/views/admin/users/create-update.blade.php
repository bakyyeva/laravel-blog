            ...
            <div class="example-container">
                <div class="example-content">
                    ...
                    <form action="{{ isset($user) ? route('user.edit', ['user' => $user->username]) : route('user.create') }}"
                        ...
                        <textarea name="about" id="about" class="m-b-sm">{!! isset($article) ? $article->about : "" !!}</textarea>
                        <div class="row mt-5">
                            <div class="col-8">
                                ...
                                <select name="image" id="image" class="form-control">
                                    ...
                                    <option value="/assets/images/user-images/default.png">Profile 3</option>
                                </select>
                            </div>
                            <div class="col-4">
                                <img src="{{ isset($user->image) ? asset($user->image) : "" }}" id="profileImage" class="img-fluid" style="max-height: 100px">
                            </div>
                        </div>
